...
as far as \isi{E-language} goes, a system of micro-parameters would appear to
...
In order to create the focus construction\is{focus}, the \emph{ang} DP is fronted and
that fronted DP is followed by another particle \emph{ang}.

\ea \ili{Tagalog}
    \sn
    \gll  \textbf{Ang} \textbf{babae} \greybox{ang} bumili ng bigas\\
...
\ea Merina
	\sn
	\gll  \textbf{Rakoto} \greybox{no} manasa ny lambanay\\
...
\ea
    {}[ Neg/RaisingV  [$_V$ \textcolor{gray}{\Cop{}} ] DP \dots{} ]
\z
...
\textbf{Step 1}:  Our first task in understanding what our expectations are for
...
\eqref{ex:pcps}.\largerpage

\ea  Cleft
    \ea \textbf{It}  \uuline{is a small dog that saw the child}\label{ex:csp} \hfill \textbf{Subj} \uuline{Pred}
     \ex \uuline{is a small dog that saw the child } \textbf{it}\label{ex:cps} \hfill \uuline{Pred} \textbf{Subj}
    \z
\z

\ea  Pseudo-cleft
    \ea  \textbf{The thing that saw the child }  \uuline{is a small dog}\label{ex:pcsp} \hfill \textbf{Subj} \uuline{Pred}
     \ex \uuline{Is a small dog} \textbf{the thing that saw the child} \label{ex:pcps} \hfill \uuline{Pred} \textbf{Subj}
    \z
\z

\textbf{Step 2}:  Because we know that these languages do not have overt
copulas, we can take these out of our expected structures.

\ea
    \ea \uuline{\textcolor{gray}{is} a small dog that saw the child } \textbf{it} \hfill \textsc{cleft}
    \ex \uuline{\textcolor{gray}{is} a small dog} \textbf{the thing that saw the child} \hfill \textsc{pseudo-cleft}
    \z
\z

\textbf{Step 3}:  Because we know that these languages do not have expletive\is{expletives}
subjects, we can take these out of the relevant expected structures (i.e. the
cleft).

\ea
    \ea \uuline{\textcolor{gray}{is} a small dog that saw the child } \textcolor{gray}{it} \hfill \textsc{cleft}
    \ex \uuline{\textcolor{gray}{is} a small dog} \textbf{the thing that saw the child} \hfill \textsc{pseudo-cleft}
    \z
\z

\textbf{Step 4}:  Because we know that these languages have headless relatives,
we can the head of the relative out of the relevant structure (i.e. the
pseudo-cleft).

\ea
    \ea \uuline{\textcolor{gray}{is} a small dog that saw the child } \textcolor{gray}{it} \hfill \textsc{cleft}
    \ex \uuline{\textcolor{gray}{is} a small dog} \textbf{the \textcolor{gray}{thing} that saw the child}  \hfill \textsc{pseudo-cleft}
    \z
\z
...
\ea
    \gll C: [ \textcolor{gray}{is} \textbf{a small dog} ~ ~ \greybox{that} ~ ~ \textbf{saw} \textbf{the} \textbf{child} ][ \textcolor{gray}{it} ] \label{ex:littewords}\\
    PC:  [ \textcolor{gray}{is} \textbf{a small dog} ] [ \greybox{the} \textcolor{gray}{thing} \greybox{that} \textbf{saw} \textbf{the} \textbf{child} ] \\
\z
...
\ea \ili{Tagalog}
    ...
    \glt `The woman bought rice.'\\
    \ex
    \gll  \textbf{Ang} \textbf{babae} \greybox{ang} bumili ng bigas\label{ex:cleftT}\\
    \Nom{} woman \Nom{} \At.\textsc{buy} \Acc{} rice\\
    \glt `It is the woman who bought rice.'
    \z
\z
...
\ea \ili{Tagalog}
    \sn
    \gll Pagod \textbf{ang} \uuline{bumili} \uuline{ng} \uuline{bigas}\label{ex:angNOMat}\\
...
\ea \ili{Tagalog}
    \ea
    \gll \uuline{binili} \uuline{ng} \uuline{babae} ang bigas\label{ex:angNOMtt}\\
    \Tto{}.buy \Gen{} woman \Nom{} rice\\
    \glt `The rice was bought by the woman.'\\
    \ex
    \gll mahal \textbf{ang} \uuline{binili} \uuline{ng} \uuline{babae}\\
...
\eqref{ex:ALNK1} and \eqref{ex:ALNK2}).
...
\ea \ili{Tagalog} \label{ex:relcl}
    ...
    \ex
    \gll mahal \textbf{ang} bigas \textbf{na} \uuline{binili} \uuline{ng} \uuline{babae}\\
...
\ea
    ...
    \ex  \uuline{Where} I bought rice was at the market.
    \ex  That is rice \uuline{which}/\textbf{that} the woman bought.
    \ex  That is the woman \uuline{who}/\textbf{that} bought rice.
    \ex That is the market \uuline{where}/\textbf{*that} the woman bought rice.
    \z
\z
...
\ea Merina
    ...
    tired  \Det{} man \Rel{} \Prs.\At{}.wash \Det{} clothes.\Fpl.\Excl{}\\
...
\ea Bezanozano
	\sn
	\gll Rakoto \textbf{\greybox{i}} manasa \textbf{i} lambanay\\
...
\ea Betsimisaraka
    \ea
    \gll tsy ny olona \textbf{mihitsy} \greybox{\textbf{no}} tokony hiaro an'Andriamanitra\\
    ...
    \ex
    \gll 15\%n'ny \ili{Malagasy} \textbf{ihany} \greybox{\textbf{no}} manana jiro\\
...
\ea  \ili{Tagalog}: Focussed DP $=$ Pseudo-cleft (there is a  nominal marker \emph{ang})\\
    \ea
    \gll  \textbf{Ang} \textbf{babae} \greybox{ang} \uuline{bumili} \uuline{ng} \uuline{bigas}\\
    \Nom{} woman \Nom{} \At.\textsc{buy} \Acc{} rice\\
    \glt `[\textsubscript{DP} \greybox{The} \textcolor{gray}{one who} \uuline{bought rice} ] [\textsubscript{VP} \textcolor{gray}{is} \textbf{the woman} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} \textbf{DP} ] ~~ [\tss{DP} \greybox{\emph{ang}} \uuline{V O} ]\\
...
\ea  \ili{Tagalog}: Focussed PP $=$ Cleft (there is no \emph{ang})\\
    ...
    \glt `[\textsubscript{VP} \textcolor{gray}{was} \textbf{at the market} \textcolor{gray}{that} the woman bought rice. ] [\tss{DP} \textcolor{gray}{It} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} PP  ~~ [\textsubscript{CP}  V O S ] ] \textcolor{gray}{Expletive}\\
    \textsc{Predicate}   ~~~~~~ ~~~~ ~~~~~~~~~ \textsc{Subject}
    \z
\z
...
\ea Bezanozano: Focussed DP $=$ Pseudo-cleft (there is a  nominal marker  \emph{i})
    \ea
    \gll \textbf{Rakoto} \textbf{\greybox{i}} \uuline{manasa} \uuline{\textbf{i}} \uuline{lambanay}\\
    Rakoto \Det{} \Prs.\At{}.wash \Det{} clothes.\Fpl.\Excl{}\\
    \glt `[\tss{DP} \greybox{The} \textcolor{gray}{one who} \uuline{is washing our clothes} ] [\textsubscript{VP} \textcolor{gray}{is} \textbf{Rakoto} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} \textbf{DP} ] ~~ [\tss{DP} \greybox{\emph{i}} \uuline{V O} ]\\
    \textsc{Predicate}  ~~~~~~ \textsc{Subject}
    \z
\z
...
\ea  Bezanozano: Focussed PP $=$ Cleft (there is an optional \emph{i})\\
    \ea
    \gll \textbf{Amin'i} \textbf{penin-janako} \greybox{(\textbf{i})} manorotra aho\\
    with.\Gen{}.\Det{} pen-child.\Fsg.\Gen{} \emph{i} \Prs.\At{}.write \Fsg{}.\Nom{}\\
    \glt `[\textsubscript{VP} \textcolor{gray}{was} \textbf{with my child's pen} \greybox{(that)} I am writing. ] [\tss{DP} \textcolor{gray}{It} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} PP  ~~ [\textsubscript{CP}  \greybox{\emph{(i)}} V  S ] ] \textcolor{gray}{Expletive}\\
    \textsc{Predicate}   ~~~~~~ ~~~~ ~~~~~ \textsc{Subject}
    \z
\z
...
\ea Merina: Focussed DP $=$ Cleft (there is a clausal marker \emph{no})\\
    ...
    \glt `[\textsubscript{VP} \textcolor{gray}{was} \textbf{Rakoto} \greybox{that} is washing our clothes. ] [\tss{DP} \textcolor{gray}{It} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} DP  ~~ [\textsubscript{CP}  \greybox{\emph{no}} V  S ] ] \textcolor{gray}{Expletive}\\
    \textsc{Predicate}   ~~~~~~ ~~~~ ~~~~~~ \textsc{Subject}
    \z
\z
\newpage
\ea Merina
    \ea
    \gll Amin'ny penina \greybox{no} manorotra aho\\
    with.\Gen{}.\Det{} pen \emph{no} \Prs.\At{}.write \Fsg{}.\Nom{}\\
    \glt `[\textsubscript{VP} \textcolor{gray}{was} \textbf{with my child's pen} \greybox{that} I am writing. ] [\tss{DP} \textcolor{gray}{It} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} PP  ~~ [\textsubscript{CP}  \greybox{\emph{no}} V  S ] ] \textcolor{gray}{Expletive}\\
    \textsc{Predicate}   ~~~~~~ ~~~~ ~~~~~~ \textsc{Subject}
    \z
\z
...
L.~Travis) and SSHRC grant 410-2011-0977 (PI: I.~Paul), as well as crucial
