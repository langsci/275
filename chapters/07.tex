...
fronted and that fronted DP is followed by another particle \emph{ang}.
...
\ea
    \gll C: [ \textcolor{gray}{is} \textbf{a small dog} ~ ~ \custombox{that} ~ ~ \textbf{saw} \textbf{the} \textbf{child} ][ \textcolor{gray}{it} ] \label{ex:littewords}\\
    PC:  [ \textcolor{gray}{is} \textbf{a small dog} ] [ \custombox{the} \textcolor{gray}{thing} \custombox{that} \textbf{saw} \textbf{the} \textbf{child} ] \\
\z
...
\ea  \ili{Tagalog}: Focussed DP $=$ Pseudo-cleft (there is a  nominal marker \emph{ang})\\
    \ea
    \gll  \textbf{Ang} \textbf{babae} \custombox{ang} \uuline{bumili} \uuline{ng} \uuline{bigas}\\
    \Nom{} woman \Nom{} \At.\textsc{buy} \Acc{} rice\\
    \glt `[\textsubscript{DP} \custombox{The} \textcolor{gray}{one who} \uuline{bought rice} ] [\textsubscript{VP} \textcolor{gray}{is} \textbf{the woman} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} \textbf{DP} ] ~~ [\tss{DP} \custombox{\emph{ang}} \uuline{V O} ]\\
...
\ea Bezanozano: Focussed DP $=$ Pseudo-cleft (there is a  nominal marker  \emph{i})
    \ea
    \gll \textbf{Rakoto} \textbf{\custombox{i}} \uuline{manasa} \uuline{\textbf{i}} \uuline{lambanay}\\
    Rakoto \Det{} \Prs.\At{}.wash \Det{} clothes.\Fpl.\Excl{}\\
    \glt `[\tss{DP} \custombox{The} \textcolor{gray}{one who} \uuline{is washing our clothes} ] [\textsubscript{VP} \textcolor{gray}{is} \textbf{Rakoto} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} \textbf{DP} ] ~~ [\tss{DP} \custombox{\emph{i}} \uuline{V O} ]\\
    \textsc{Predicate}  ~~~~~~ \textsc{Subject}
    \z
\z
...
\ea  Bezanozano: Focussed PP $=$ Cleft (there is an optional \emph{i})\\
    ...
    \glt `[\textsubscript{VP} \textcolor{gray}{was} \textbf{with my child's pen} \custombox{(that)} I am writing. ] [\tss{DP} \textcolor{gray}{It} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} PP  ~~ [\textsubscript{CP}  \custombox{\emph{(i)}} V  S ] ] \textcolor{gray}{Expletive}\\
    \textsc{Predicate}   ~~~~~~ ~~~~ ~~~~~ \textsc{Subject}
    \z
\z
...
\ea Merina: Focussed DP $=$ Cleft (there is a clausal marker \emph{no})\\
    ...
    \glt `[\textsubscript{VP} \textcolor{gray}{was} \textbf{Rakoto} \custombox{that} is washing our clothes. ] [\tss{DP} \textcolor{gray}{It} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} DP  ~~ [\textsubscript{CP}  \custombox{\emph{no}} V  S ] ] \textcolor{gray}{Expletive}\\
    \textsc{Predicate}   ~~~~~~ ~~~~ ~~~~~~ \textsc{Subject}
    \z
\ex  Merina
    \ea
    ...
    with.\Gen{}.\Det{} pen \emph{no} \Prs.\At{}.write \Fsg{}.\Nom{}\\
    \glt `[\textsubscript{VP} \textcolor{gray}{was} \textbf{with my child's pen} \custombox{that} I am writing. ] [\tss{DP} \textcolor{gray}{It} ]' \\
    \ex $[$\textsubscript{VP} \textcolor{gray}{\Cop{}} PP  ~~ [\textsubscript{CP}  \custombox{\emph{no}} V  S ] ] \textcolor{gray}{Expletive}\\
    \textsc{Predicate}   ~~~~~~ ~~~~ ~~~~~~ \textsc{Subject}
    \z
\z
