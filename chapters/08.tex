...
\ex\label{ex2c}
\emph{till}\hspace{0.3cm} \^P\hspace{0.3cm} \makebox[0pt][l]{(\emph{f}
\textsc{aspect telic})}\phantom{(\emph{f} \textsc{aspect durative})} = \textminus\\
...
\hphantom{\emph{till}\hspace{0.3cm} \^P\hspace{0.3cm}} (\emph{f} \textsc{aspect durative}) = \textminus
\end{xlist}
\end{exe}
...
value [\textminus{}finite] and that finiteness in \ili{English} is, in general, a
