...
\ea \mbox[\textsubscript{CP} Op [\textsubscript{Cʹ} C+V\textsubscript{fin} [\textsubscript{TP} subj.pron. [\textsubscript{Tʹ} T [\textsubscript{VP} \ldots{} ]]]]]\\ $\rightarrow$ \isi{agreement} weakening
\ex \mbox[\textsubscript{CP} XP [\textsubscript{Cʹ} C [\textsubscript{TP} [\textsubscript{Tʹ} T+V\textsubscript{fin} [\textsubscript{VP} DP subject \ldots{}]]]]]\\
$\rightarrow$ regular \isi{agreement}
\ex \mbox[\textsubscript{CP} XP [\textsubscript{Cʹ} C [\textsubscript{TP} subj.pron. [\textsubscript{Tʹ} T+V\textsubscript{fin} [\textsubscript{VP}
