...
\ea
	\ea \mbox [\textsubscript{CP} [\textsubscript{AgrsP} They [\textsubscript{Agrs$ʹ$} are [\textsubscript{TP} [\textsubscript{T$ʹ$} T [\textsubscript{VP} going]]]]]]\\
	\ex \mbox [\textsubscript{CP} [\textsubscript{AgrsP} [\textsubscript{Agrs$ʹ$} [\textsubscript{TP} The teachers [\textsubscript{T$ʹ$} is [\textsubscript{VP} busy]]]]]]\\
    \z
\z
...
\Ssg{} pronoun \emph{thou}, compare the somewhat idealized system in \Cref{tab:trips:10.1}
...
signal any person or number distinctions (compare \Cref{tab:trips:10.1} above). So
...
\Cref{tab:trips:10.2} above). At least from a morphological point of view, the
...
\gls{NSR}, in contrast to the system listed in \Cref{tab:trips:10.2} above.
...
system in \Cref{tab:trips:10.2} above (following standard assumptions, more
...
\ea \mbox[\textsubscript{CP} Op [\textsubscript{C$ʹ$} C+V\textsubscript{fin} [\textsubscript{TP} subj.pron. [\textsubscript{T$ʹ$} T [\textsubscript{VP} \ldots{} ]]]]]\\ $\rightarrow$ \isi{agreement} weakening
\ex \mbox[\textsubscript{CP} XP [\textsubscript{C$ʹ$} C [\textsubscript{TP} [\textsubscript{T$ʹ$} T+V\textsubscript{fin} [\textsubscript{VP} DP subject \ldots{}]]]]]\\
$\rightarrow$ regular \isi{agreement}
\ex \mbox[\textsubscript{CP} XP [\textsubscript{C$ʹ$} C [\textsubscript{TP} subj.pron. [\textsubscript{T$ʹ$} T+V\textsubscript{fin} [\textsubscript{VP}
...
\ea
\ea \mbox[\textsubscript{CP} XP [\textsubscript{C$ʹ$} C+V\textsubscript{fin} [\textsubscript{TP} subject [\textsubscript{T$ʹ$} T [\textsubscript{VP} \ldots{}]]]]]\\
\ex \mbox[\textsubscript{CP} subject [\textsubscript{C$ʹ$} C+V\textsubscript{fin} [\textsubscript{TP} t\textsubscript{subj} [\textsubscript{T$ʹ$} T [\textsubscript{VP} \ldots{} ]]]]]
\z
\z
...
a binary inventory of \isi{agreement} markers ([+phi] $\varnothing$\ vs.\ [\textminus phi]
...
suggests that the development of this system, which corresponds to \Cref{tab:trips:10.1}, proceeded via a set of intermediate stages where blank generation of
