...
Examples of P-stranding\is{preposition stranding} in present-day English are given in (1a-b),
exemplifying P-stranding\is{preposition stranding} by \textit{wh}-movement in \textit{wh}-relative
clauses. \textit{Wh}-movement in \isi{relative clauses} moves a constituent to
...
comparable to \REF{ex:key:11.1}. Relative clauses\is{relative clauses} that involve \isi{movement} of an
...
preposition along to Spec, CP, as in \REF{ex:key:11.2}:
...
and long relativisation, in \REF{ex:key:11.3} (both from
\citealt[147--148]{vanKemenade1987}), of an infinitival relative in
\REF{ex:key:11.4}, and an example of an adjective+infinitive construction in
\REF{ex:key:11.5}.
...
\ea LS8 (Eust) 315 \parencite[266]{Fischeretal:2000}%5
    \label{ex:key:11.5}
    \sn
...
(6c) shows that R-pronouns also move to Spec,CP. \Citet{vanKemenade1987}
...
\begin{itemize}
    ...
    \item the parallelism between P-stranding\is{preposition stranding} by
        \textit{þær} and pronouns, and P-stranding\is{preposition stranding} in
...
Note that the clause introduced by \textit{þær} in \REF{ex:key:11.8} is
...
neuter antecedents, such as \REF{ex:key:11.9b} with neuter \textit{sweord} as
...
exemplified in \REF{ex:key:11.10}; two examples have a feminine antecedent
\REF{ex:key:11.11}. Four examples have a relative form other than \textit{þæt},
...
\REF{ex:key:11.11}, remarkably with a feminine antecedent
