...
\ea\label{ex:schifano:12.4} Group 1 / 3 (Italian)\\
	\ea[*]{
...
\ex \label{ex:schifano:12.5} \ili{Italian}
	\ea\label{ex:schifano:12.5a} Group 1 / *3\\
        ...
        can.}\newpage
	\ex\label{ex:schifano:12.5b} Group 1 / 3\\
...
\ea\label{ex:schifano:12.13} For a given value \emph{v\textsubscript{i}} of a parametrically variant feature F:
	...
	\ex \textit{Mesoparameters}: all functional heads\is{functional items} of a given naturally definable class, e.g.\ [+V], share \emph{v\textsubscript{i}};
...
\begin{figure}
  \caption{\color{red}Please provide a caption\label{ex:schifano:12.15}}
    \hspace*{-.25cm}
