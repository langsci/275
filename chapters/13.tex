...
syntactically grounded and universal.”\hfill(\citealt[3]{SelkirkLee2015})\\[1\baselineskip]
%
...
\begin{exe}
    \ex\label{ex:key:13.11} \begin{tikzpicture}[baseline=(XP.base)]
...
More significantly for our purposes, \tabref{ex:key:13.37} shows that \gls{HTP} also
...
\ref{ex:key:13.39}). The unavoidable conclusion is that Lusoga
...
(\ref{ex:key:13.43}a,b).\largerpage[1]
