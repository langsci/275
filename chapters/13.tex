...
the less common left-bran\-ch\-ing structure in (\ref{ex:13.17}b), N\tss{1}\,+\,N\tss{2} 
first form a constituent, which then joins N\tss{3}. Although a
...
[\textsc{\textminus focus}] status as was discussed in \ili{Luganda}. Recall that negative
