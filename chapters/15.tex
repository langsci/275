...
Furthermore, I shall argue that an ``interrogation \emph{qua} \isi{predication}''
...
predicate: predicating (\emph{i.e.} ascribing properties).
...
\begin{exe}
    \ex\label{WG1} \ili{Kalaallisut}% \parencite[199]{sadock1984}
    \sn     Nerivoq%\hfill{Kalaallisut}
    \sn\gll neri-vu-q\\
            eat-\Indic{}-\Tsg{}\\
    \glt `He ate.'
...
\ex\label{nivkh1} Nivkh
    \sn\gll If	p‘rə-\textsubrhalfring{d}\\
            s/he come-\Ind{}\\
            \glt `S/he came.'
...
(Pama-Nyungan) with \emph{mi\textsubbridge{n}akuri} (intransitive) \emph{vs.}
\emph{mi\textsubbridge{n}akana} (transitive) \citep{blake1979}, or in languages
...
\sn\gll q\tuple{um}uni=isu tangi?\\
...
\emph{qua} \isi{predication}, and it is as such incongruent.
