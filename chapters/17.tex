...
\ex Achievement predicate\\
   \label{achievement predicate} \gll {tɔ} {sasə} {fəŋʣoŋ} lidou {mə} {lə} sa bən ʃy. \\
...
\ex Accomplishment predicate\\
   \label{accomplishment predicate} \gll  {tɔ} {sasə} {fəŋʣoŋ} lidou {ʧε} {lə} sa {ʣə} bɪŋgo. \\
...
\begin{exe}
    \ex \ili{Yixing Chinese}\\
     \gll {ʤu} ŋo {jiʤiŋ} {ʧε} \textbf{lə} lɨ. \\
