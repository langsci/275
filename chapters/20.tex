...
phenomenon (as shown in \Cref{tab:key:20.2} and exemplified in
...
considered decomposable (as schematized here: [\tss{1} \emph{burn}] [\tss{2}
\emph{one’s boats/bridges}] ‘[\tss{1} destroy] [\tss{2} options of reversing
the situation]’; [\tss{1} \emph{one’s red bulb}] [\tss{2} \emph{lit up}]
‘[\tss{1} one’s suspicion] [\tss{2} arose]’). Nondecomposable \isi{idioms} were
...
adjectival passive\is{passive} \isi{idioms}, Appendix A).
...
to participants did not include indications of
diatheses)\vspace{.25\baselineskip}
