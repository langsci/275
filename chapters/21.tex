...
\begin{figure}
\caption{\color{red}Please provide caption\label{tree1}}
...
subject.\todo{Add reference to Figure in this sentence?}
...
\begin{figure}
\caption{\color{red}Please provide a caption and reference in the text\label{ag-tree}}
\begin{tikzpicture}[baseline=(root.base)]
...
\begin{figure}
\caption{\color{red}Please provide a caption and reference the figure in the main text.\label{ag-tree2}}
\begin{tikzpicture}[baseline=(root.base)]
...
\begin{figure}
\caption{\color{red}Please provide a caption\label{suidhetree}}
\begin{tikzpicture}[baseline=(root.base)]
...
\begin{figure}
\caption{\color{red}Please provide a caption.\label{fig:adger:GaelicSt}}
\begin{tikzpicture}[baseline=(root.base)]
...
\ea \ili{Scottish Gaelic}\\
    ...
    \glt \hspaceThis{*} \enquote*{His sister is a councillor who I will vote for.}
\z
...
inclusion of one class in another in~\eqref{eun},\todo{Please check ref!} and it performs an identical
...
\begin{figure}
\caption{\color{red}Please provide a caption and reference the figure in your main text.}
\begin{tikzpicture}[baseline=(root.base)]
    \Tree 	[.\node(root){TP};
                [.TP
                    {Cop$'$\\{is e$_{i}$}}
